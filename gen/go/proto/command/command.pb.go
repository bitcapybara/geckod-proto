...
var file_proto_command_command_proto_rawDesc = []byte{
	...
	,
...
var file_proto_command_command_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
...
var file_proto_command_command_proto_goTypes = []interface{}{
	...
	(Error_Code)(0),                 // 3: command.Error.Code
	(*BaseCommand)(nil),             // 4: command.BaseCommand
	(*Connect)(nil),                 // 5: command.Connect
	(*Connected)(nil),               // 6: command.Connected
	(*Producer)(nil),                // 7: command.Producer
	(*ProducerSuccess)(nil),         // 8: command.ProducerSuccess
	(*Subscribe)(nil),               // 9: command.Subscribe
	(*SubscribeSuccess)(nil),        // 10: command.SubscribeSuccess
	(*Send)(nil),                    // 11: command.Send
	(*Message)(nil),                 // 12: command.Message
	(*Ack)(nil),                     // 13: command.Ack
	(*Flow)(nil),                    // 14: command.Flow
	(*Unsubscribe)(nil),             // 15: command.Unsubscribe
	(*Topics)(nil),                  // 16: command.Topics
	(*Error)(nil),                   // 17: command.Error
}
var file_proto_command_command_proto_depIdxs = []int32{
	5,  // 0: command.BaseCommand.connect:type_name -> command.Connect
	6,  // 1: command.BaseCommand.connected:type_name -> command.Connected
	7,  // 2: command.BaseCommand.producer:type_name -> command.Producer
	8,  // 3: command.BaseCommand.producer_success:type_name -> command.ProducerSuccess
	9,  // 4: command.BaseCommand.subscribe:type_name -> command.Subscribe
	10, // 5: command.BaseCommand.subscribe_success:type_name -> command.SubscribeSuccess
	11, // 6: command.BaseCommand.send:type_name -> command.Send
	12, // 7: command.BaseCommand.message:type_name -> command.Message
	13, // 8: command.BaseCommand.ack:type_name -> command.Ack
	14, // 9: command.BaseCommand.flow:type_name -> command.Flow
	15, // 10: command.BaseCommand.unsubscribe:type_name -> command.Unsubscribe
	16, // 11: command.BaseCommand.topics:type_name -> command.Topics
	17, // 12: command.BaseCommand.error:type_name -> command.Error
	...
	3,  // 16: command.Error.code:type_name -> command.Error.Code
